...
src="/home/juan/ownCloud"
dst="/media/juan/xvms/backup/test/test_owncloud_rsync_incremental"
backupDepth=7
timeout=1800
pathBak0="data"
...
-l --exclude tmp/ --exclude *[Cc]ache*/ --exclude **~ --exclude lost+found/ --exclude *[Tt]rash*/ --exclude **/.gvfs/ --exclude VirtualMachines/ --exclude docker/ --exclude .Trash-1000/"
