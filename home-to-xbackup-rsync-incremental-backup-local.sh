...
src="/home/juan"
#dst="/media/juan/xBackupDisk/backup/rsyncIncremental/sdb2home"
dst="/media/juan/xBackupDisk/backup/rsyncIncremental/sdb3home"
backupDepth=7
timeout=1800
pathBak0="home"
...
-l --exclude tmp/ --exclude *[Cc]ache*/ --exclude **~ --exclude lost+found/ --exclude *[Tt]rash*/ --exclude **/.gvfs/ --exclude VirtualMachines/ --exclude docker/ --exclude .Trash-1000/ --exclude *[Ss]nap*/"
