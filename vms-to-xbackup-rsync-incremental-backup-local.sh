...
src="/data/VirtualMachines"
dst="/media/juan/xBackupDisk/backup/rsyncIncremental/virtualMachines"
backupDepth=3
timeout=1800
pathBak0="virtualMachines"
...
-l --exclude tmp/ --exclude *[Cc]ache*/ --exclude **~ --exclude lost+found/ --exclude *[Tt]rash*/ --exclude **/.gvfs/ --exclude docker/ --exclude .Trash-1000/ --exclude *[Ss]nap*/"
